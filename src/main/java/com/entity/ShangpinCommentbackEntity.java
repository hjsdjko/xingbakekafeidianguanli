...
public class ShangpinCommentbackEntity<T> implements Serializable {
     ...
     * 评价图片
     */
    @TableField(value = "shangpin_commentback_photo")

    private String shangpinCommentbackPhoto;
	 ...
	 * 设置：评价图片
	 */
    public String getShangpinCommentbackPhoto() {
        return shangpinCommentbackPhoto;
    }
    ...
    public void setShangpinCommentbackPhoto(String shangpinCommentbackPhoto) {
        this.shangpinCommentbackPhoto = shangpinCommentbackPhoto;
    }
    /**
	 * 设置：评价内容
	 */
    ...
    public String toString() {
        return "ShangpinCommentback{" +
            ...
            ", yonghuId=" + yonghuId +
            ", shangpinCommentbackPhoto=" + shangpinCommentbackPhoto +
