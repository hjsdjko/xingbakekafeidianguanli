...
//            shangpinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if("".equals(shangpinCommentback.getShangpinCommentbackPhoto()) || "null".equals(shangpinCommentback.getShangpinCommentbackPhoto())){
                shangpinCommentback.setShangpinCommentbackPhoto(null);
        }
        shangpinCommentback.setUpdateTime(new Date());
        if(shangpinCommentbackEntity==null){
            //  String role = String.valueOf(request.getSession().getAttribute("role"));
            //  if("".equals(role)){
            //      shangpinCommentback.set
            //  }
...
//                            shangpinCommentbackEntity.setShangpinCommentbackPhoto("");//照片
