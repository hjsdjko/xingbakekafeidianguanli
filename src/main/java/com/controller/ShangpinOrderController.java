...
//                            shangpinOrderEntity.setShangpinOrderUuidNumber(data.get(0));                    //取餐号 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
                        ...
                        if(shangpinOrderEntities_shangpinOrderUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [取餐号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            //赋值订单信息
            shangpinOrderEntity.setShangpinOrderUuidNumber(shangpinOrderUuidNumber);//取餐号
    ...
    */
    ...
    public R commentback(Integer id, String commentbackText,String shangpinCommentbackPhoto,HttpServletRequest request){
        ...
        if(shangpinOrder.getShangpinOrderTypes() != 4)
        ...
        ShangpinCommentbackEntity shangpinCommentbackEntity = new ShangpinCommentbackEntity();
            ...
            shangpinCommentbackEntity.setShangpinCommentbackPhoto(shangpinCommentbackPhoto);
            ...
            shangpinOrder.setShangpinOrderTypes(5);//设置订单状态为已评价
            shangpinOrderService.updateById(shangpinOrder);//根据id更新
            return R.ok();
        }else{
